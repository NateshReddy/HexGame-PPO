...
class hexPosition (object):
    ...
    def move (self, coordinates):
        ...
        """
        assert (self.winner == 0), "The game is already won." #Error message wenn es schon einen Sieger gibt 
        assert (self.board[coordinates[0]][coordinates[1]] == 0), "These coordinates already contain a stone." #Error Message wenn ein illigialer Zug ist
